...
- **WAN 구간 (HDLC)**:
  - `210.116.41.32/30` (R1 ↔ ISP-1) - 128Kbps
  - `210.116.41.40/30` (ISP-6 ↔ ISP-5) - 128Kbps
  - `210.116.41.44/30` (ISP-5 ↔ R2) - **64Kbps**
  - `210.116.41.36/30` (ISP-1 ↔ ISP-6) - 128Kbps
...
| **EX3** | OSPF Multi-Area 구성 + ISP-3 DR 선출 + Loopback Area 분리 | [`03-ospf-router-preconfig.txt`](./preconfig/03-ospf-router-preconfig.txt) |
| **EX4** | ISP-1에서 Extended ACL로 R1 → R2/R3 트래픽 제어 |  [`04-ospf-acl-preconfig.txt`](./preconfig/04-ospf-acl-preconfig.txt) |
...
11.11.11.11      1   FULL/  -    00:00:35    210.116.41.34    Serial1/0
```
